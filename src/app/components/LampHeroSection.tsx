  ...
  return (
    <LampContainer className="w-full ">
      <motion.h1
        ...
        className="-mt-[300px] relative   bg-gradient-to-br from-slate-300 to-slate-500  bg-clip-text text-center text-4xl font-medium tracking-tight md:text-transparent md:text-7xl"
      >
        <div className="top-[220px] md:top-40  relative z-10 w-full text-center">
          <h1 className=" text-3xl md:text-7xl font-bold bg-clip-text text-transparent  bg-gradient-to-b from-neutral-50 to-neutral-400">
